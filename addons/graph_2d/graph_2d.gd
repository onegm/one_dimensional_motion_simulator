...
@export var show_horizontal_line: bool = true:
	set(value):
		...
		_update_graph()
## Allows [member x_max] to increase based on the added points
@export var horizontal_scaling : bool = true:
	set(value):
...
@export var show_vertical_line: bool = true:
	set(value):
		...
		_update_graph()
## Allows [member y_max] to increase based on the added points
@export var vertical_scaling : bool = true:
	set(value):
